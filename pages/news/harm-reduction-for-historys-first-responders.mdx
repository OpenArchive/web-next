...
In this post, we will cover the following: documentarians' and human rights archivists' emergent contexts and needs when capturing and archiving evidentiary media, threats to the media, documenters, and archivists, and emerging tactics and tools to help protect them. This blog is part of a series that explores how and whether decentralized storage technologies are suitable for our human rights archivist communities. [In the first blog](https://open-archive.org/news/mapping-the-decentralized-storage-ecosystem), we mapped out the technical functionalities of the current state of Decentralized Web (DWeb) storage and future publications will build on this one to extrapolate the risks and benefits these technologies pose/offer to our communities. The ultimate goal of our research is to learn how human rights defenders, often at risk, can benefit from the verification, privacy, and long-term preservation features of DWeb storage and to identify which privacy and usability updates are needed in order to safeguard it for them, thus protecting the broader public downstream.
