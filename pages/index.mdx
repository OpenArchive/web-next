---
title: OpenArchive
description: Anyone with a phone can expose injustice. OpenArchive helps history's first responders safely store, verify, and share critical evidence.
...
<HeaderSection>
  # Saving the present, **transforming the future.**

Anyone with a phone can expose injustice. OpenArchive helps history's first responders safely store, verify, and share critical evidence. We provide harm reducction by collaborating with communities to conduct co-research, build responsive tools, and create guides to advance human rights.

</HeaderSection>
<ArchivingSection>
  ## **Human Rights Archiving** in practice

We safeguard our histories by creating tools to verify and securely route [mobile media](/save) to community-maintained collections in public and private archives. Our work protects eyewitnesses and their evidentiary media from digital threats like surveillance, targeting, content removal, media manipulation, and other harms.
...
<ProjectsSection>
  ...
  <ProjectItem>
    ...
    Explore our guides and toolkits to learn how to preserve evidence of injustice and combat disinformation.
...
Citizen reporters _•_ Eyewitnesses _•_ Activists _•_ Documentarians _•_ Human Rights Defenders _•_ Legal Advocates _•_ Academics _•_ Newsrooms _•_ Archivists _•_ Librarians _•_ Historians
