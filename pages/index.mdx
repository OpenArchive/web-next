...
Anyone with a phone can expose injustice. OpenArchive helps history's first responders safely store, verify, and share critical evidence. We conduct co-research, build tools, and create guides to advance human rights.

</HeaderSection>
<ArchivingSection>
  ## **Human Rights Archiving** in practice

OpenArchive safeguards our histories by creating tools to verify and securely route [mobile media](/save) to community-maintained collections in public and private archives. We work to protect eyewitnesses and their evidentiary media from the those who threaten the integrity of historical records via digital threats such as surveillance, targeting, takedowns, media manipulation, etc.
