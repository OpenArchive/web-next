...
We are seeking a Lead Mobile Developer to ensure our flagship secure archiving app [***Save***](https://open-archive.org/save) (Share, Archive, Verify, Encrypt) is as up-to-date, secure, and easy-to-use as possible for our users and [Decentralized Archivist Communities](https://open-archive.org/programs) (DACs). 
...
This position reports to OpenArchive's Executive Director and Deputy Director.
...
We will consider applications on a rolling basis. Priority will be given to applicants who submit materials by March 31, 2024.
